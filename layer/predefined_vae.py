...
from layer.dense import Attention
from layer.dense import SeqNorm
from layer.common import FFN_SwiGLU, RMSNorm
...
class BlockGT(nn.Module):
    def __init__(self, d, num_heads):  
        ...
        self.MLPx = FFN_SwiGLU(d, 4 * d)
        self.MLPe = FFN_SwiGLU(d, 4 * d)
